...
@section('content')
    <div class="row">
        <div class="col-md-12">
            ...
            <h2 class="page-title">Edicion de Tipo de Pregunta</h2>
        </div>
    </div>
        ...
        <div class="col-md-12">
            ...
            <div class="panel panel-success">
                ...
                <div class="panel-body">
                    {!!Form::model($orden,['route'=>['iordenpregunta.update', $orden->id],'method'=>'PUT','role'=>'form','enctype'=>'multipart/form-data', 'class'=>'form-horizontal'])!!}
                ...
                <div class="hr-dashed"></div>
                    <div class="form-group">
                        <div class="col-sm-8 col-sm-offset-2">
                            ...
                            <a href="{{route('bpregunta.principal')}}" class="btn btn-danger btn-sm"> Cancel <i class=" fa fa-fast-forward"></i> </a>
                        </div>
                    </div>
                    {!!Form::close()!!}
                </div>
