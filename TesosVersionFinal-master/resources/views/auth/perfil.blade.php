...
@section('content')
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <h2 class="page-title">Edicion de Perfil de usuario</h2>
        </div>
    </div>
        ...
        <div class="col-md-12">
            ...
            <div class="panel panel-success">
                ...
                <div class="panel-body">
                    {!!Form::model($perfil,['route'=>['iperfil.update', $perfil->id],'method'=>'PUT','role'=>'form','enctype'=>'multipart/form-data', 'class'=>'form-horizontal'])!!}
