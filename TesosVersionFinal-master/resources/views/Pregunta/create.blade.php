...
@section('content')
    <div class="row">
        <div class="col-md-12">
            ...
            <h2 class="page-title">Registro Preguntas</h2>
        </div>
    </div>
        ...
        <div class="col-md-12">
            ...
            <div class="panel panel-success">
                ...
                <div class="panel-body">
                    {!!Form::open(['route'=>'ipregunta.store','method'=>'POST','role'=>'form','enctype'=>'multipart/form-data', 'class'=>'form-horizontal'])!!}
                    ...
                    <div class="form-group">
                        <label for="inputPassword1" class="col-lg-2 control-label from-control">Tutor</label>
                        <div class="col-lg-10">
