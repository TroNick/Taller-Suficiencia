...
@section('content')
    <div class="row">
        <div class="col-md-12">
            ...
            <h2 class="page-title">Edicion de Usuarios</h2>
        </div>
    </div>
        ...
        <div class="col-md-12">
            ...
            <div class="panel panel-success">
                ...
                <div class="panel-body">
                    {!!Form::model($eusuario,['route'=>['iusercontrol.update', $eusuario->id],'method'=>'PUT','role'=>'form','enctype'=>'multipart/form-data', 'class'=>'form-horizontal'])!!}
