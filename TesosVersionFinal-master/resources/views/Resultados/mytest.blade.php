...
--}}
                    ...
                    <table class="table table-striped">
                        ...
                        <tr>
                            ...
                            <th>
                                <a href="{{ route('pdf',$parameters = [Auth::user()->name,$reg->carrera_elegida, $reg->carrera_seleccionada, $reg->estado ]) }}"  target="_blank" class="btn btn-dark btn-sm" id="btnNuevo"><i class="fa fa-users"></i>Imprimir Resultado</a>
                                <a href="{{ route('certificado',$parameters = [Auth::user()->name,$reg->carrera_elegida, $reg->carrera_seleccionada, $reg->estado ]) }}"  target="_blank" class="btn btn-linkedin btn-sm" id="btnNuevo"><i class="fa fa-users"></i>Ver Certificado</a>
